...
|---|---|---|
| [governance](governance/README.md) | Who decides what, what was decided, what London gets and when | `decision-log.md` |
...
| [people](people/README.md) | The eight, the open seats, hiring | — |
