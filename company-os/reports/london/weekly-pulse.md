...
## Objectives (status of each, one line)

1 DD2 by 1 Oct — [status]. 2 Breakeven — [status]. 3 Website Factory — [status]. 4 Finnera — [status]. 5 3DS/2D US-EU — [status]. 6 LATAM template — [status]. 7 DD2 checklists — [status]. 8 Chargeblast CAID — [status]. 9 Phones — [status]. 11–13 KYB stack — [status].

## Blockers (reported the hour they appeared; repeated here)

- [blocker] — since [date] — owner [name] — needs [what]
...
- [one line each, from the decision log]
