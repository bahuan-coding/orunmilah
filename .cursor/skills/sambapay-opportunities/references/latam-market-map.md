...
- Brazil: entity live (A55 Payments Ltda); partner MoR live; production volume on DD1 Cielo; DD2 in parallel (secondary entity template from Double Diamond; three acquirers side by side, two OTC partners; date the accounts open: Open). Latin America is a cheap market: geographies that are very cost-efficient. Scores Open.
